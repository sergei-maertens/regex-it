    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', django_countries.fields.CountryField(default='NL', max_length=2, verbose_name='Country')),
                ('language', models.CharField(choices=[('en', 'English'), ('nl', 'Dutch'), ('nl_BE', 'Dutch (Belgium)')], default='nl', max_length=10, verbose_name='language')),
                ('crn', models.CharField(blank=True, help_text='KvK number', max_length=50, verbose_name='registration number')),
                ('vat', models.CharField(blank=True, max_length=50, verbose_name='VAT number')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='created')),
                ('modified', models.DateTimeField(auto_now=True, verbose_name='modified')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_rate', models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name='hourly base rate')),
                ('flat_fee', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='flat fee')),
